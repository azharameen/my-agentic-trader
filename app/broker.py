...
class BrokerAdapter(Protocol):
    ...
    def open_trade(
        self, proposal: TradeProposal, rsi: float = 0.0, ema_200: float = 0.0, atr: float = 0.0,
        thesis: str = "", human_decision: str = "", news_headlines: list[str] | None = None,
        evidence_snapshot_id: str | None = None, strategy_name: str | None = None,
        market_regime: str | None = None, catalyst_type: str | None = None,
        source_set: list[str] | None = None, llm_provider: str | None = None,
        llm_model: str | None = None, cache_hits: list[str] | None = None,
    ) -> dict:
...
class PaperBroker:
    ...
    def open_trade(
        ...
        return executor.record_open_trade(
            proposal, rsi, ema_200, atr, thesis, human_decision, news_headlines,
            evidence_snapshot_id, strategy_name, market_regime, catalyst_type,
            source_set, llm_provider, llm_model, cache_hits,
        )
